    ...
    return (
        ...
        {/* Header */}
            <div className="w-full flex items-center justify-between px-6 py-3">
                ...
                {/* Title */}
                <div className="flex items-center gap-1 text-lg font-semibold text-[rgba(45,55,72,1)]">
                    Intro to programming
                    <img src="/icons/course/arrow-down-v2.png" alt="arrow-down" />
                </div>
            ...
            <div className="w-[80%] max-w-[1100px] mx-auto p-6 space-y-6">
                {/* Main Post */}
